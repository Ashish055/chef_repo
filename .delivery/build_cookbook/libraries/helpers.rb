...
module BuildCookbook
  module Helpers
    ...
    def terraform_directory_for(stage)
      ...
      File.join(repo_terraform_directory, subdir)
    end

    # Construct a hash that can be provided to a chef_managed_instance terraform module
    def terraform_environment_vars(stage = workflow_stage, environment = workflow_chef_environment_for_stage)
      {
