...
#
# They generally recomend 25% of avalable memory but set an upper
# bound of for machines with very large amounts of memory.
pg_autocalc_max = 14*1048576 # 14 GB
quarter_mem = [node['memory']['total'].to_i/4, pg_autocalc_max].min
default['private_chef']['postgresql']['shared_buffers'] = "#{(quarter_mem/1024).to_i}MB"
