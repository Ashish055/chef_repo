     ...
     [
      ...
      {"check_publish_not_at_capacity",
       fun() ->
            ...
            oc_chef_action_queue:set_rabbit_queue_monitor_setting(queue_length_monitor_enabled, true),
            oc_chef_action_queue:set_rabbit_queue_monitor_setting(drop_on_full_capacity, true),
      ...
      {"no_queue_length_monitor",
       fun() ->
          ...
          oc_chef_action_queue:set_rabbit_queue_monitor_setting(queue_length_monitor_enabled, false),
          oc_chef_action_queue:set_rabbit_queue_monitor_setting(drop_on_full_capacity, false),
      ...
      {"queue_monitor_timeout",
       fun() ->
            ...
            % after 10 millis.
            oc_chef_action_queue:set_rabbit_queue_monitor_setting(queue_length_monitor_timeout_millis, 0),
