...
check_health() ->
    ...
    QueueMonStatus =
        case oc_chef_action_queue:get_rabbit_queue_monitor_setting(queue_length_monitor_enabled, false) of
...
queue_at_capacity_affects_overall_status() ->
    oc_chef_action_queue:get_rabbit_queue_monitor_setting(queue_at_capacity_affects_overall_status, false).
